...
from rest_framework import mixins, generics, viewsets  # type: ignore # Fixed typo here
...
class Employees(mixins.ListModelMixin, mixins.CreateModelMixin, generics.GenericAPIView):
    ...
    serializer_class = EmployeeSerializer  # Correct usage of serializer class
...
class EmployeeDetail(mixins.RetrieveModelMixin, mixins.UpdateModelMixin, mixins.DestroyModelMixin, generics.GenericAPIView):  # No need for CreateModelMixin here
    queryset = Employee.objects.all()
    serializer_class = EmployeeSerializer  # Correct usage of serializer class
...
"""class EmployeeViewSet(viewsets.ViewSet):  # Ensure this matches in urls.py
...
class BlogsView(generics.ListCreateAPIView):
    ...
    search_field = ['blog_title', 'blog_body']
